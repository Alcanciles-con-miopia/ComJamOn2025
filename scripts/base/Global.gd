...
var expansion4: Array = [Vector2(0,0),Vector2(0,1),Vector2(0,2),Vector2(0,3),Vector2(0,4),Vector2(0,5),Vector2(0,6),Vector2(0,7),Vector2(0,8),Vector2(0,9),Vector2(1,0),Vector2(2,0),Vector2(3,0),Vector2(4,0),Vector2(5,0),Vector2(6,0),Vector2(7,0),Vector2(8,0),Vector2(9,0)] # Celdas de expansion del adulto al viejo.
var expansion5: Array = [Vector2(9,1),Vector2(9,2),Vector2(9,3),Vector2(9,4),Vector2(9,5),Vector2(9,6),Vector2(9,7),Vector2(9,8),Vector2(9,9),Vector2(1,9),Vector2(2,9),Vector2(3,9),Vector2(4,9),Vector2(5,9),Vector2(6,9),Vector2(7,9),Vector2(8,9)] # Celdas de expansion del adulto al viejo.
var expansions: Array = [initialCells, expansion1, expansion2, expansion3, expansion4, expansion5] # Aqui estan todos para ir iterando al pasar de fase vital.
# - Arbol
