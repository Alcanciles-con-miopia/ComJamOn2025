...
var expansion2: Array = [Vector2(1,1),Vector2(4,1),Vector2(5,1),Vector2(6,1),Vector2(7,1),Vector2(1,2),Vector2(1,3),Vector2(1,4),Vector2(7,4),Vector2(7,5),Vector2(1,7),Vector2(2,7),Vector2(3,7),Vector2(4,7),Vector2(7,6),Vector2(7,7)] # Celdas de expansion del nino al joven.
